...
export function ThemeToggle() {
  ...
  return (
    <aside className="fixed right-4 top-4 z-50 rounded-full border border-stone-200/80 bg-white/95 p-1.5 shadow-md backdrop-blur-md dark:border-stone-700/60 dark:bg-stone-900/90 transition-all duration-300">
