...
export function ContinueReadingCard() {
  ...
  return (
    <section className="w-full max-w-md rounded-2xl border border-stone-300 bg-white px-4 py-4 shadow-sm">
      ...
      <Link
        ...
        className="mt-3 inline-flex rounded-lg bg-stone-900 px-4 py-2 text-sm font-medium text-stone-50 transition hover:bg-stone-700"
      >
        Continue Reading
      </Link>
