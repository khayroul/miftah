  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section
        ...
        aria-label="Ringkasan rutin hari ini"
      >
        ...
        <div className="min-w-0">
          ...
          <div
            ...
            role="progressbar"
            aria-label="Progres sasaran harian"
            aria-valuemin={0}
            aria-valuemax={100}
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-1.5 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
                ...
                kepada{" "}
                <strong>
                  {legacyHifzGoalRecommendation.suggestedPageGoal} halaman
                </strong>{" "}
                supaya sasaran dan pelan Hafal menggunakan unit yang sama.
              </p>
              {hifzGoalMigrationError ? (
      ...
      <section className="space-y-4">
        <div className="px-1">
          ...
          <h2 className="mt-1 text-2xl font-semibold tracking-tight text-stone-900 dark:text-stone-50">
            Belajar mengikut keperluan anda
          </h2>
        </div>
            ...
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div>
                ...
                <h3 className="mt-1 text-lg font-semibold tracking-tight text-stone-900 dark:text-stone-50">
                  Uji hafalan dengan bacaan suara
                </h3>
                <p className="mt-1 text-sm leading-relaxed text-stone-600 dark:text-stone-300">
                  Pilih juzuk, baca tanpa melihat mushaf, dan semak keputusan sesi.
                </p>
              </div>
            </div>
            <OfflineAwareLink
